...
def index():
    ...
    image_file_progress = url_for('static', filename='progress.jpg')
    ...
    return render_template(
        ...
        image_file_learn=image_file_learn,
        image_file_progress=image_file_progress,
        image_file_teacher=image_file_teacher,
